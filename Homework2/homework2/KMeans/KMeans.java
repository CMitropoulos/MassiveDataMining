...
public class KMeans {
	...
	public static String CENTROID_FILE_NAME = "../data/c1.txt";
	public static String OUTPUT_FILE_NAME = "/part-00000";
	public static String DATA_FILE_NAME = "../data/data.txt";
	public static String JOB_NAME = "KMeans";
	public static String SPLITTER = "\t| ";
	public static List<Double> mCenters = new ArrayList<Double>();
	public static List<Double> costs = new ArrayList<Double>();
